...
private:
    ...
    static double calcularCosto(const std::vector<Nodo>& ruta, double distancias[][15]);
    ...
    static std::vector<std::vector<int>> kernighanLinParticion(double** graph, int numnodos);
